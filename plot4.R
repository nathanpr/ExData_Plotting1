...
#plot 2
plot(as.numeric(levels(powerDays$Voltage))[powerDays$Voltage], 
     type="o", pch=NA, xaxt='n', 
     main = "",  xlab ="datetime", ylab = "Voltage")

lsize <- length(powerDays$Voltage)
axis(1, at=0,labels="Thu", col.axis="black", las=0)
axis(1, at=lsize/2,labels="Fri", col.axis="black", las=0)
axis(1, at=lsize,labels="Sat", col.axis="black", las=0)
...
#plot 4
plot(as.numeric(levels(powerDays$Global_reactive_power))[powerDays$Global_reactive_power], 
     type="o", pch=NA, xaxt='n', 
     main = "",  xlab ="datetime", ylab = "Global_reactive_power")

lsize <- length(powerDays$Global_reactive_power)
axis(1, at=0,labels="Thu", col.axis="black", las=0)
axis(1, at=lsize/2,labels="Fri", col.axis="black", las=0)
axis(1, at=lsize,labels="Sat", col.axis="black", las=0)
